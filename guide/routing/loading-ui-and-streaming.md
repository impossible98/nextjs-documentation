...
> **Good to know**:
>
> - Navigation is immediate, even with [server-centric routing](/guide/routing/linking-and-navigating#how-routing-and-navigation-works).
...
In addition to `loading.js`, you can also manually create Suspense Boundaries for your own UI components. The App Router supports streaming with [Suspense](https://react.dev/reference/react/Suspense) for both [Node.js and Edge runtimes](/guide/rendering/edge-and-nodejs-runtimes).
