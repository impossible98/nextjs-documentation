...
1. `rewrite` to a route ([Page](/guide/routing/pages-and-layouts) or [Route Handler](/guide/routing/route-handlers)) that produces a response
...
1. `rewrite` to a route ([Page](/guide/routing/pages-and-layouts) or [Edge API Route](/docs/pages/building-your-application/routing/api-routes)) that produces a response
2. return a `NextResponse` directly. See [Producing a Response](#producing-a-response)
